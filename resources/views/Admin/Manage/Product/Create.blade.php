...
@section('content') {{-- 網頁文章區塊 --}}
    ...
    <div class="container text-center" style="color: black">
        <form name="input" action="/product" method="post">
            @csrf
            輸入圖片網址&emsp;
            <input type="text" name="product_photo">
            <br>
            <br>
            輸入文章標題&emsp;
            ...
            <br>
            <br>
            <textarea name="product_content" cols="30" rows="10"></textarea>
            <br>
            <br>
            輸入文章上傳日期&emsp;
            ...
            <br>
            輸入文章有關資訊&emsp;
            <input type="text" name="product_about">
            <br>
            <br>
