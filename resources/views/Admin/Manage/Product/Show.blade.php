...
@section('content') {{-- 網頁文章區塊 --}}
    ...
    <div class="container">
        <div class="row py-5">
            <div class="col-5">
                <div>
                    <img src="{{ $product['photo'] }}" style="height: 540px" alt="...">
                </div>
            </div>
            ...
            <div class="col-6" style="color: black">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <span style="font-size: 115%">{{ $product['content'] }}</span>
                    </div>
                    <hr>
                    {{-- 日期 --}}
                    <div class="col">
                    ...
                    <div class="col">
                        <span style="font-size: 115%">{{ $product['date'] }}</span>
                    </div>
                    <hr>
                    {{-- 相關資訊 --}}
                    <div class="col">
                    ...
                    <div class="col">
                        <span style="font-size: 115%">{{ $product['about'] }}</span>
                    </div>
                    <hr>
                    {{-- 操作 --}}
                    <div class="col">
                    ...
                    <div class="col">
                        <a href="/product/{{ $product['id'] }}/edit" class="btn btn-info">編輯產品所有資訊</a>
