...
@section('content') {{-- 網頁文章區塊 --}}
    ...
    <div class="container">
        <div class="row py-5">
            <div class="col-5">
                <div>
                    <img src="{{ $activity['photo'] }}" style="height: 540px; wdith: 350px" alt="...">
                </div>
            </div>
            ...
            <div class="col-6" style="color: black">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <span style="font-size: 115%">{{ $activity['content'] }}</span>
                    </div>
                    <hr>
                    {{-- 日期 --}}
                    <div class="col">
                    ...
                    <div class="col">
                        <span style="font-size: 115%">{{ $activity['date'] }}</span>
                    </div>
                    <hr>
                    {{-- 相關資訊 --}}
                    <div class="col">
                    ...
                    <div class="col">
                        <span style="font-size: 115%">{{ $activity['about'] }}</span>
                    </div>
                    <hr>
                    {{-- 操作 --}}
                    <div class="col">
                    ...
                    <div class="col">
                        <a href="/activity/{{ $activity['id'] }}/edit" class="btn btn-info">編輯產品所有資訊</a>
